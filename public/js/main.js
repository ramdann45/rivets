...
nav = document.getElementById(navId) , xnav = document.querySelector('.x-nav')
...
// // close login
// const close = document.querySelector('.kotak .close i');
...
// close navbar-mobile
// let x = document.querySelector('.x-mobile').children[0];
